...
"<div class=\"ui right floated pagination menu\">"+
    "  <a class=\"pagination-first page-item\"\n        *ngIf=\"boundaryLinks\"\n        [class.disabled]=\"noPrevious()||disabled\">\n " +
    "     <a class=\"item\" href (click)=\"selectPage(1, $event)\" [innerHTML]=\"getText('first')\"></a>\n    </a>\n\n  "+
    "  <a class=\"pagination-prev page-item\"\n        *ngIf=\"directionLinks\"\n        >\n  "+
    "    <a class=\"icon item\" [class.disabled]=\"noPrevious()||disabled\" href (click)=\"selectPage(page - 1, $event)\" > <i class=\"left chevron icon\"></i></a>\n      </a>\n\n "+
    "   <a *ngFor=\"let pg of pages\"\n              [class.disabled]=\"disabled&&!pg.active\"\n        class=\"pagination-page page-item\">\n  "+
    "    <a class=\"item\" [class.active]=\"pg.active\"\n   href (click)=\"selectPage(pg.number, $event)\" [innerHTML]=\"pg.text\"></a>\n    </a>\n\n "+
    "   <a class=\"pagination-next page-item\"\n        *ngIf=\"directionLinks\"\n        >\n  "+
    "    <a class=\"icon item\" [class.disabled]=\"noNext()||disabled\" href (click)=\"selectPage(page + 1, $event)\" > <i class=\"right chevron icon\"></i></a></a>\n\n  "+
    "  <a class=\"pagination-last page-item\"\n        *ngIf=\"boundaryLinks\"\n        [class.disabled]=\"noNext()||disabled\">\n   "+
    "   <a class=\"item\" href (click)=\"selectPage(totalPages, $event)\" [innerHTML]=\"getText('last')\"></a></a>\n  "+
    "</div>";
